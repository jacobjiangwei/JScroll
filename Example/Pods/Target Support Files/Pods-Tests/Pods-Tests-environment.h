...
// JScroll
#define COCOAPODS_POD_AVAILABLE_JScroll
#define COCOAPODS_VERSION_MAJOR_JScroll 0
#define COCOAPODS_VERSION_MINOR_JScroll 1
#define COCOAPODS_VERSION_PATCH_JScroll 0
